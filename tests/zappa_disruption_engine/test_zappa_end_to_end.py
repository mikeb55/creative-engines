"""End-to-end tests for Zappa Disruption engine."""
...
def test_zappa_registered():
    ensure_engines_loaded()
    assert "zappa_disruption" in list_engines()


def test_zappa_end_to_end_generation():
