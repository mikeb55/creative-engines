"""Tests for Bartók Night form planner."""

from form_planner import plan_form, build_phrase_plan, score_form_interest


def test_plan_form():
    form = plan_form(0, "atmospheric_sections")
...
def test_score_form_interest():
    form = plan_form(0, "floating_segments")
