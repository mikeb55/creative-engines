"""Pytest conftest: add bartok-night-engine to path for imports."""

import sys
import os
import pytest

_engine_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..", "engines", "bartok-night-engine"))
