"""Tests for Bartók Night generator."""
...
def test_generate_from_title():
    ir = generate_composer_ir_from_title("Night Study", seed=0)
...
def test_generate_from_premise():
    ir = generate_composer_ir_from_premise("sparse atmospheric texture", seed=42)
    assert ir.title
    assert ir.section_order
