...
exports.STAFF_COUNT = exports.BIG_BAND_STAFF_LAYOUT = void 0;
exports.getPartIds = getPartIds;
exports.getGroupForSection = getGroupForSection;
exports.BIG_BAND_STAFF_LAYOUT = [
...
exports.STAFF_COUNT = exports.BIG_BAND_STAFF_LAYOUT.length;
function getPartIds() {
    return exports.BIG_BAND_STAFF_LAYOUT.map((s) => s.partId);
}
function getGroupForSection(section) {
    const s = section.toLowerCase();
    if (s.includes('sax') || s.includes('reed'))
        return 'saxes';
    if (s.includes('trumpet'))
        return 'trumpets';
    if (s.includes('trombone') || s.includes('brass'))
        return 'trombones';
    if (s.includes('rhythm') || s.includes('piano') || s.includes('guitar') || s.includes('bass') || s.includes('drum'))
        return 'rhythm';
    return 'saxes';
}
