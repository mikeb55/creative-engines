"""
Hill Interval Language — Wide intervals, minor seconds, tritones, major sevenths.
"""
...
PROFILES = {
    "angular": ([6, 11, 1], [5, 7, 10], []),  # tritone, M7, m2
    "wide_angular": ([11, 6, 10], [1, 5], []),  # M7, tritone, m9
    "cluster_adjacent": ([1, 2, 11], [6, 5], []),  # m2, M2, chromatic
}
