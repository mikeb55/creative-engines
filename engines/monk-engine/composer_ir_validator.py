...
MONK_VALID_MOTION = {"blues_shadowed", "altered_dominant", "chromatic_shift", "stride_shadow"}
...
def validate_harmonic_field(composer_ir: Any) -> ValidationResult:
    ...
    if hasattr(hf, "motion_type") and hf.motion_type and hf.motion_type not in MONK_VALID_MOTION:
        r.warnings.append(f"harmonic motion type '{hf.motion_type}' not in Monk set")
    return r
