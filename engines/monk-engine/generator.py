"""
Monk Generator — Assemble ComposerIR from title/premise.
"""
...
PROFILES = ["angular", "repeated_cell", "leap_m2"]
HARMONY_PROFILES = ["blues_shadowed", "altered_dominant", "chromatic_shift", "stride_shadow"]
FORM_PROFILES = ["compact_16", "quirky_17", "blues_12", "odd_15"]
...
def generate_composer_ir_from_title(title: str, seed: int = 0, profile: str = "angular") -> ComposerIR:
    ...
    ir = ComposerIR(
        ...
        form_plan=form.get("profile", "compact_16"),
        ...
        phrase_plan=pp,
        contrast_plan=ContrastPlan(section_contrasts={"contrast": 0.6, "return": 0.7}),
