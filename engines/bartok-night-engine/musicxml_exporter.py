"""
Bartók Night MusicXML Exporter — Valid MusicXML with rests between fragments.
"""
...
def export_composition_to_musicxml(compiled: CompiledComposition) -> str:
    """Export to MusicXML. Includes rests between fragments."""
    ...
    tempo = compiled.metadata.get("tempo", 60)
    fifths = {"C": 0, "G": 1, "D": 2, "A": 3, "E": 4, "B": 5, "F": -1, "Bb": -2, "Eb": -3, "F#": 6, "G#": 8, "Ab": -4}.get(key_hint, 0)
    lines = [
