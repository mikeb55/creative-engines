"""
Zappa Disruption MusicXML Exporter.
"""
...
def export_composition_to_musicxml(compiled: CompiledComposition) -> str:
    ...
    tempo = compiled.metadata.get("tempo", 140)
    fifths = {"C": 0, "G": 1, "D": 2, "A": 3, "E": 4, "B": 5, "F": -1, "Bb": -2, "Eb": -3, "F#": 6, "Db": -5}.get(key_hint, 0)
    lines = [
