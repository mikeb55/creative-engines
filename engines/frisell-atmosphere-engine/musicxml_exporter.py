"""
Frisell Atmosphere MusicXML Exporter — Valid MusicXML with spacious phrasing.
"""
...
def export_composition_to_musicxml(compiled: CompiledComposition) -> str:
    """Export to MusicXML. Includes rests where needed."""
    ...
    tempo = compiled.metadata.get("tempo", 66)
