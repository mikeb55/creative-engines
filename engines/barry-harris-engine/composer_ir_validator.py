...
BH_VALID_MOTION = {"major6_dim", "minor6_dim", "dominant_dim", "minor_conversion"}
...
def validate_harmonic_field(composer_ir: Any) -> ValidationResult:
    ...
    if hasattr(hf, "motion_type") and hf.motion_type and hf.motion_type not in BH_VALID_MOTION:
        r.warnings.append(f"harmonic motion type '{hf.motion_type}' not in BH set")
    return r
