"""
Ligeti Texture MusicXML Exporter — Valid compact MusicXML blueprint.
"""
...
def export_composition_to_musicxml(compiled: CompiledComposition) -> str:
    """Export to MusicXML. Texture blueprint as simplified lines."""
    ...
    tempo = compiled.metadata.get("tempo", 72)
    fifths = {"C": 0, "G": 1, "D": 2, "A": 3, "E": 4, "B": 5, "F": -1, "Bb": -2, "Eb": -3, "F#": 6, "Ab": -4}.get(key_hint, 0)
    lines = [
        '<?xml version="1.0" encoding="UTF-8"?>',
        '<score-partwise version="4.0">',
        '  <work><work-title>' + _escape(compiled.title) + '</work-title></work>',
        '  <part-list>',
        '    <score-part id="P1"><part-name>Texture</part-name></score-part>',
        '  </part-list>',
        '  <part id="P1">',
    ]
